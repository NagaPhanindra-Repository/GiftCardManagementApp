package com.britenet.universoeportalswagger.controller;
...
import com.britenet.universoeportalswagger.exception.ResourceNotFoundException;
import com.britenet.universoeportalswagger.model.ETCProcessCards;
import com.britenet.universoeportalswagger.model.appInfo;
import com.britenet.universoeportalswagger.model.card;
import com.britenet.universoeportalswagger.model.contactForm;
import com.britenet.universoeportalswagger.model.loyaltyCard;
import com.britenet.universoeportalswagger.repository.CardRepository;
...
public class ResourceController {
    ...
    public ResponseEntity<ObjectNode> createSmsRequest(
        @ApiParam(value = "loyalty and  mainCardLoyalty Required", required = true) @Valid @RequestBody loyaltyCard card) throws Exception {
    ...
    public ResponseEntity<ObjectNode> createlinkRequest(
        @ApiParam(value = "loyalty, mainCardLoyalty, sessionId and token are required ", required = true) @Valid @RequestBody loyaltyCard card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> verifyUser(
        @ApiParam(value = "nif and pvl are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> activateTemporaryCard(
        @ApiParam(value = "nif, etc,degressivity and pvl are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> checkAccountAndCard(
        @ApiParam(value = "cardNumber and MCCode are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> forceActivateCard(
        @ApiParam(value = "publicKeyId, cardNumber, encryptedPin, oldMCCode, newMCCode and degressivity are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> forceMultipleChannelCodeSetting(
        @ApiParam(value = "cardNumber,nif and MCCode are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    	//JSONObject opcard=new JSONObject();
    	opcard.put("status", "Success");
    ...
    public ResponseEntity<ObjectNode> submitContactForm(
        @ApiParam(value = "lista,lista, lang, formid, fname_77, lname_78, campoe_27_79, email_75, ind_telemovel_76, telemovel_76_numero, campoe_31_81,campoe_29_80 are required", required = true) @Valid @RequestBody contactForm card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    	//JSONObject opcard=new JSONObject();
    	opcard.put("status", "Success");
    	opcard.put("response", "(…)<div class=\"easygoi-message\" style=\"text-align: center;\">\n<p>Os seus dados foram alterados com sucesso.</p> (…)</body>\n</html>\n");
    ...
    public ResponseEntity<ObjectNode> validateMC(
        @ApiParam(value = "nif and MCCode are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> addCradToCradHolder(
        @ApiParam(value = "cardBIN,cardBrand, cardHolderName, cardHolderNIF, cardIdentifier, cardNumber, cardStatus, expiryDate and registrationDate are required", required = true) @Valid @RequestBody card card) throws Exception {
    ...
    public ResponseEntity<ObjectNode> updateEmployee(
        ...
        @ApiParam(value = "deactivate Wallet Card with specified cardId ", required = true) @Valid @RequestBody card card) throws ResourceNotFoundException {
    	ObjectNode opcard = objectMapper.createObjectNode();
    ...
    public ResponseEntity<ObjectNode> getAllCards(
        @ApiParam(value = "nif and cardsType are required", required = true) @Valid @RequestBody ETCProcessCards card) throws Exception {
    	ObjectNode cardInfo = objectMapper.createObjectNode();
    	//JSONObject cardInfo=new JSONObject();
    	cardInfo.put("cardBIN", "518224");
    	cardInfo.put("cardBrand", "MASTERCARD");
